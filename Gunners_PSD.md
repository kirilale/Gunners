...
| **Mapbox GL JS** | 2.x | Interactive maps | Global fan map visualization |
...
| **Prisma ORM** | 5.x | Database toolkit | Type-safe queries, migrations, schema management |
...
| **Zod** | 3.x | Schema validation | Runtime type checking for API inputs |
...
- 25+ achievement types across categories:
  - Attendance: 1, 10, 25, 50, 100 check-ins
  - Streaks: 3, 5, 10, 20 consecutive matches
  - Geographic: Different cities/countries
  - Predictions: Exact score accuracy
